...
import { bCount } from '../totalBooks/TotalBooks';
...
export default function NavBar() {
    ...
    const bookCount = useContext(bCount);
    console.log("This is the bookcount", bookCount)
    return (
        <Box sx={{ flexGrow: 1 }}>
            <AppBar className='nb-app-bar'>
